...
<html lang="en">
  ...
  <body>
    ...
    <!-- <div class="faqMain container py-5 gap-4">
        ...
        <div class="accordion" id="accordionExample">
          <div class="accordion-item">
            ...
            >
              <div class="accordion-body">
                ...
                client engagements and helping our partner companies grow. We
                would be happy to share testimonials from companies like yours,
                too!
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              ...
              >
                Can we start any time of years?
              </button>
            </h2>
            <div
              id="collapseTwo"
      ...
      <div>
        <img src="/Assets/images/faq/faqImage.png" alt="faq-image" class="img-fluid" />
      </div>
    </div> -->
            ...
            <div class="accordion" id="accordionExample">
              <div class="accordion-item">
                ...
                >
                  <div class="accordion-body">
                    Our solution is agile and flexible, so we can adjust as your
                    needs change.We take great pride in having long-standing client
                    engagements and helping our partner companies grow. We would be
                    happy to share testimonials from companies like yours, too!
                  </div>
                </div>
              </div>
